        ...
        <Modal title="Invoice Details" width={400} pagination={false} visible={popModal} onCancel={() => setPopModal(false)} footer={false}>
          <div className="card" ref={componentRef}>
            <div className="cardHeader">
                <h2 className="logo">SP POS</h2>
                <span>Number: <b>+1-248-000-0000</b></span>
                <span>Address: <b>8310 Phoenix, AZ</b></span>
            </div>
            <div className="cardBody">
                ...
                <div className="group">
                    ...
                    <span><b>${selectedBill.totalAmount.toFixed(2)}</b></span>
                </div>
            </div>
            <div className="cardFooter">
                ...
                <div className="footerCardTotal">
                    <div className="group">
                        <h3>Total:</h3>
                        <h3><b>${selectedBill.totalAmount.toFixed(2)}</b></h3>
                    </div>
                </div>
